...
export const CONFIG = {"title":"陳年卷宗","genre":"點擊推理","visual":"rooms","accent":"#d6a85f","actions":{"search":"搜查熱點","move":"換房間","take":"收存證物","combine":"組合證據","accuse":"指認兇手"},"help":"走訪檔案室、暗房與站長室。找到底片與班表，組合成不在場證明後指認站長。","test":["search","take","move","search","take","combine","search","search","accuse"],"id":"pg-casefile"};
